...
public class SPUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = SkinConfig.SKIN_INFO_NAME;
    ...
    public static String getSkinPath(Context context){
        String path = (String) get(context, SkinConfig.SKIN_PATH_NAME, "");
        return path;
    }

    public static void saveSkinPath(Context context,String skinPath){
        put(context,SkinConfig.SKIN_PATH_NAME,skinPath);
    }

    public static void cleanSkinPath(Context context){
        remove(context, SkinConfig.SKIN_PATH_NAME);
    }
}
